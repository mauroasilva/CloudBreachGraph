...
3. A **`learnings_phaseX.md`** file that each phase writes at the repo root (or in
   `docs/learnings/`, see `04_conventions.md`) capturing every decision, deviation,
   assumption, and gotcha that later phases must know about.
...
3. Let it complete. It will commit code **and** write `learnings_phase1.md`.
